...
$query="UPDATE appointment_requests SET status='approved' WHERE id=$request_id;";
$query_result=mysqli_query($conn,$query) or die(mysqli_error($conn));

$query="UPDATE patient_requests SET status='approved' WHERE request_id=$request_id;";
